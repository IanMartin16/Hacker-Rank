...
class Result {
    ...
    public static int hurdleRace(int k, List<Integer> height) {
        // Encontrar la altura máxima de las barreras
        int maxHurdleHeight = Collections.max(height);
        
        // Calcular la diferencia entre la altura máxima y la altura natural del personaje
        int dosesNeeded = maxHurdleHeight - k;
        
        // Si la diferencia es negativa, no se necesita ninguna dosis de la poción
